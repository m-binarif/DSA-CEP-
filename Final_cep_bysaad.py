...
st.sidebar.markdown("1️⃣ Choose Compress or Decompress\n2️⃣ Upload your file\n3️⃣ Download the result\n4️⃣ View file stats below")
...
with tab1:
    ...
    uploaded_file = st.file_uploader(
        ...
        help="Select a text file to compress"
    )
    ...
    if uploaded_file:
        try:
            ...
            with zipfile.ZipFile(zip_buffer, "w") as zf:
                # Save encoded binary as text inside ZIP
...
with tab2:
    ...
    uploaded_file = st.file_uploader(
        "Upload a Compressed ZIP file",
        type=["zip"],
        key="decompress_uploader",
        help="ZIP must contain compressed.bin and codes.json"
    )
